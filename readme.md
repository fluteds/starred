...
- [nikolaischunk/discord-phishing-links](https://github.com/nikolaischunk/discord-phishing-links) - An actively maintained JSON List containing 7000+ malicious  Domains which are used for phishing on Discord.
