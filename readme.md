...
- [nikolaischunk/discord-phishing-links](https://github.com/nikolaischunk/discord-phishing-links) - An actively maintained JSON List containing 6900+ malicious  Domains which are used for phishing on Discord.
